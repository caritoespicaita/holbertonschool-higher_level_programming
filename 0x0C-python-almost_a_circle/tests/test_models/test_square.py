...
class testSquare(unittest.TestCase):
    ...
    def test_raise_height_no_int(self):
        self.assertRaises(TypeError, Square, 2, "prueba")
    ...
    def test_raise_y_no_int(self):
        self.assertRaises(TypeError, Square, 4, 8, "prueba")

    def test_raise_x_no_int(self):
        self.assertRaises(TypeError, Square, 2, 2, "prueba")
    ...
    def test_methode_to_json_string(self):
        ...
        self.assertEqual(
            r5.to_json_string(("prueba", "prueba1")), '["prueba", "prueba1"]'
        )